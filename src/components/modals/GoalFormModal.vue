...
// заполняем форму при каждом открытии - на будущее пригодится и для режима редактирования
...
<template>
  ...
  >
    <form class="space-y-4" @submit.prevent="handleSubmit">
      ...
      <button
        type="submit"
        class="w-full min-h-11 rounded-xl bg-moss text-paper font-medium hover:bg-moss-dark hover:-translate-y-0.5 hover:shadow-md active:scale-[0.99] active:translate-y-0 transition"
      >
        {{ $t('goalForm.submit') }}
      </button>
    </form>
